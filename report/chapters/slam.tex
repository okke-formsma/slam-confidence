...
\caption{Matching two point clouds. In \subref{fig:scanmatch41a}, the red and green point clouds are obviously not well aligned. In \subref{fig:scanmatch41b}, they are much better aligned. Images courtesy of \cite{slametpfingsthornthesis}.}
