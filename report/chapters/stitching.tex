...
\subfigure[$\theta_{1b}$]{
	\includegraphics[width=0.4\textwidth]{images/stitching/rooms-ex-result-1b.png}
	\label{fig:ex-room-result-1b}
} \\
\subfigure[$\theta_{2a}$]{
	\includegraphics[width=0.4\textwidth]{images/stitching/rooms-ex-result-2a.png}
	\label{fig:ex-rooms-result-1a}
}
\subfigure[$\theta_{2b}$]{
	\includegraphics[width=0.4\textwidth]{images/stitching/rooms-ex-result-2b.png}
	\label{fig:ex-room-result-1b}
}
\caption{The results of map stitching according to all four $\theta$ hypothesis.}
